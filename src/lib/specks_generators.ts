...
const casino_imgdata = (imgData: any) => {
...
const yellow_casino_imgdata = (imgData: any) => {
...
const specks_imgdata = (imgData: any) => {
    var inc = 0;
    var inc2 = 0;
    var inc3 = 0
    for (i = 0; i < imgData.data.length; i += 4) {
...
const specksredscale_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
...
const noise_centre_imgdata = (imgData: any) => {
...
const green_specks_imgdata = (imgData: any) => {
...
const eclectic_imgdata = (imgData: any) => {
...
const retroviolet_imgdata = (imgData: any) => {
 ...
 */
 const custom_specks = (imgData: any, colour: any, frequency = 15) => {
    let R, G, B;
...
const black_specks = (imgData: any) => custom_specks(imgData, {R: 0, G: 0, B: 0});

const white_specks = (imgData: any) => custom_specks(imgData, {R: 255, G: 255, B: 255});

const salt_and_pepper = (imgData: any) => {
