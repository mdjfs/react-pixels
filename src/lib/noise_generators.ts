...
let i, addition: any, addition1, addition2;

const green_med_noise_imgdata = (imgData: any) => {
...
const dark_purple_min_noise_imgdata = (imgData: any) => {
    let rand = (0.5 - Math.random()) * 9;
...
const teal_min_noise_imgdata = (imgData: any) => {
...
const purple_min_noise_imgdata = (imgData: any) => {
    let rand = (0.5 - Math.random()) * 1;
...
const blue_min_noise_imgdata = (imgData: any) => {
    let rand = (0.5 - Math.random()) * 1;
...
const green_min_noise_imgdata = (imgData: any) => {
    let rand = (0.5 - Math.random()) * 1;
...
const pink_min_noise_imgdata = (imgData: any) => {
    let rand = (0.5 - Math.random()) * 1;
...
const matrix_imgdata = (imgData: any) => {
    var randomNumber;
    ...
    for (i = 0; i < imgData.data.length; i += 4) {
        ...
        if (imgData.data[i] - (addition as any) > 255) {
            imgData.data[i] -= (addition as any)
        }
        else {
...
const cosmic_imgdata = (imgData: any) => {
    let randomNumber = 0;
...
const min_noise_imgdata = (imgData: any) => {
...
const red_min_noise_imgdata = (imgData: any) => {
