 ...
 */
 const threshold = (imgData: any, threshold = 100) => {
...
const threshold75 = (imgData: any) => threshold(imgData, 75);

const threshold125 = (imgData: any) => threshold(imgData, 125);

/**
 * Produces a pixelated image.
 * @param {number} sample_size - side length of block in px, default value of 10
 */
const pixelate = (imgData: any, sample_size = 10) => {
...
const pixelate16 = (imgData: any) => pixelate(imgData, 16);
