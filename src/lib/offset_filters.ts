...
const extreme_offset_blue = (imgData: any) => {
...
const extra_offset_blue = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        var offset = 15;
        imgData.data[i + 2] = imgData.data[i + 4 * offset * offset] == undefined ? 0 : imgData.data[i + 4 * offset];
    }
...
const extreme_offset_green = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        var offset = 35;
...
const extra_offset_green = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        var offset = 15;
        imgData.data[i + 1] = imgData.data[i + 4 * offset * offset] == undefined ? 0 : imgData.data[i + 4 * offset];
    }
...
const extreme_offset_red = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        var offset = 35;
...
const extra_offset_red = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        var offset = 15;
        imgData.data[i] = imgData.data[i + 4 * offset * offset] == undefined ? 0 : imgData.data[i + 4 * offset];
    }
...
const offset_green_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        var offset = 5;
        imgData.data[i + 1] = imgData.data[i + 4 * offset * offset] == undefined ? 0 : imgData.data[i + 4 * offset];
    }
...
const offset_blue_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        var offset = 5;
        imgData.data[i + 2] = imgData.data[i + 4 * offset * offset] == undefined ? 0 : imgData.data[i + 4 * offset];
    }
