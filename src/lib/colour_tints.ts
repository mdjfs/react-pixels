...
const lemon_imgdata = (imgData: any) => {
...
const coral_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
...
const frontward_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
...
const vintage_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        imgData.data[i] += 120
        imgData.data[i + 1] += 70
        imgData.data[i + 2] += 13
...
const perfume_imgdata = (imgData: any) => {
...
const serenity_imgdata = (imgData: any) => {
...
const pink_aura_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        imgData.data[i] += 90
        imgData.data[i + 1] += 10
        imgData.data[i + 2] += 90
...
const haze_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        imgData.data[i] += 90
        imgData.data[i + 1] += 90
        imgData.data[i + 2] += 10
...
const mellow_imgdata = (imgData: any) => {
...
const solange_dark_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
...
const zapt_imgdata = (imgData: any) => {
...
const neue_imgdata = (imgData: any) => {
...
const aeon_imgdata = (imgData: any) => {
...
const rosetint_imgdata = (imgData: any) => {
...
const slate_imgdata = (imgData: any) => {
...
const purplescale_imgdata = (imgData: any) => {
...
const radio_imgdata = (imgData: any) => {
...
const twenties_imgdata = (imgData: any) => {
...
const ocean_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        imgData.data[i] += 10
        imgData.data[i + 1] += 20
        imgData.data[i + 2] += 90
...
const greyscale_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
...
const redgreyscale_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        let avg = (imgData.data[i] + imgData.data[i + 1] + imgData.data[i + 2]) / 3
...
const greengreyscale_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        let avg = (imgData.data[i] + imgData.data[i + 1] + imgData.data[i + 2]) / 3
...
const evening_imgdata = (imgData: any) => {
    let SAT_ADJ = 60;
    for (i = 0; i < imgData.data.length; i += 4) {
...
const blue_greyscale_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        let avg = (imgData.data[i] + imgData.data[i + 1] + imgData.data[i + 2]) / 3
        imgData.data[i] = avg + 20
...
const solange_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        imgData.data[i] = 255 - imgData.data[i];
    }
    return imgData;
...
const solange_grey_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        imgData.data[i] = imgData.data[i + 2];
...
const cool_twilight_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        imgData.data[i + 1] = 255 - imgData.data[i + 1];
...
const blues_imgdata = (imgData: any) => {
    for (i = 0; i < imgData.data.length; i += 4) {
        imgData.data[i + 2] = 255 - imgData.data[i + 2];
    }
    return imgData;
...
export {blues_imgdata, cool_twilight_imgdata, blue_greyscale_imgdata, aeon_imgdata, solange_grey_imgdata, solange_imgdata, ryo_conv, lix_conv, wood, sunset, 
